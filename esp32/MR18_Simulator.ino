// MR18 ESP32 simulator scaffold: 18 channels, JSON serial protocol.
...
void setup(){ Serial.begin(115200); for(uint8_t i=0;i<CHANNELS;i++){fader[i]=75;muteState[i]=false;soloState[i]=false;} Serial.println("{\"type\":\"HELLO\",\"device\":\"MR18-ESP32-SIM\",\"channels\":18}"); }
